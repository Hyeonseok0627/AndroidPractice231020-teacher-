...
class TestImageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 두번째, 갤러리 앱에 데이터를 가져온 내용을 처리하는 작업. (2번 작업)
        val requestGalleryLauncher = registerForActivityResult(
            ...
            try {
                ...
                Log.d("lhs","갤러리에서 선택된 사진의 크기 비율 calRatio : $calRatio")
        ...
        // 버튼클릭시 : 갤러리 앱 호출, (1번 작업, 해당 작업 후 2번 작업으로 가게 됨)
        ...
        binding.cameraBtn.setOnClickListener {
            ...
            // 전역으로 빼기.
            // 위에서 선언만하고, 실제 파일 위치가 나올 이 때, 할당을 하는 구조.
